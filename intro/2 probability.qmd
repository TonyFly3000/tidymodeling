...
## soluition 2:P(at least one)=1-P(no one snoring)
...
## Question 5.what is probability of choose 4 number from 4 number and 4 correct
...
## Normal Distribtion(also called Gaussian distribution)
